...
Payment from `sktime` is milestone based, and the same (FTE pro-rated) as [Google Summer of Code stipends](https://developers.google.com/open-source/gsoc/help/student-stipends).
