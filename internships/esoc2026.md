# Welcome to sktime's European Summer of Code program 2026! 
...
- [Why sktime](https://github.com/sktime/mentoring/blob/main/internships/esoc2026.md#why-sktime)
- [The application process](https://github.com/sktime/mentoring/blob/main/internships/esoc2026.md#the-application-process)
  - [Entrace task, sktime application form](https://github.com/sktime/mentoring/blob/main/internships/esoc2026.md#entrace-task-sktime-application-and-esoc-proposal)
  - [Getting feedback on proposal](https://github.com/sktime/mentoring/blob/main/internships/esoc2026.md#getting-feedback-on-your-proposal)
  - [Interview](https://github.com/sktime/mentoring/blob/main/internships/esoc2026.md#interview)
  - [Selection criteria](https://github.com/sktime/mentoring/blob/main/internships/esoc2026.md#selection-criteria-for-initial-application-phase)
- [What we expect from you](https://github.com/sktime/mentoring/blob/main/internships/esoc2026.md#what-we-expect-from-you)
- [What you can expect from us](https://github.com/sktime/mentoring/blob/main/internships/esoc2026.md#what-you-can-expect-from-us)
- [Projects](https://github.com/sktime/mentoring/blob/main/internships/esoc2026.md#projects)
...
European Summer of Code 2026 is a paid stipend programme, through April-September 2026.
...
- February 18, 18:00 (UTC). Applications via the ESoC and sktime application form open.
- March 18, 18:00 (UTC). First stage. You must complete an entrance task, the ESoC application, and the sktime application form by this deadline.
  ...
  - If you are also applying for GSoC, it is sufficient to submit a single sktime application, for both ESoC and GSoC.
- March 25. We inform you of the first stage outcome (proceed to interview) *latest* by March 25, but hopefully sooner.
- March 30 to April 10. Second stage. Interviews happen during this time. Preferred dates are April 8 and April 9. Please keep these dates free if possible.
- April 17. We take at most one week to inform you of the interview outcome. The list of ranked candidates from `sktime` is then moved to reconciliation at ESoC.
- April 17 to April 20. Third stage. Final selection. No further action from applicants is needed in this stage.
- April 30. `sktime` will inform you directly of the final outcome of the process.
- May - Projects begin.
...
The deadline to complete all of these is March 18, 18:00 (UTC). If you want feedback on a proposal, then you must complete your proposal at least one week earlier and select the option in the sktime application form. See next subsection for details.
...
2. Fill in and submit the [ESoC application form](https://www.linkedin.com/posts/european-summer-of-code_european-summer-of-code-activity-7308135810648715264-RbpO)
...
3. Fill in and submit the [sktime application form](https://forms.gle/bw4vduwQGuM6PZQg9).
    ...
    - Ensure to include a project proposal, i.e., a pdf document that describes what you intend to work on during your project. It should contain at least a description of the project and a work plan.
...
After the deadline on March 18 has passed, we will process the information provided and tell you the outcome no later than March 25. There are two possible outcomes:
...
You can request feedback from March 11, 18:00 UTC, onwards. For this, you must have also submitted your proposal through the `sktime` application form by the time you request feedback - you can update this later.
...
The interview will happen in the two-week period March 30 to April 10, and our preferred dates are March 31 and April 1. Please keep these dates free if possible.
...
We will inform you of *our* perspective on the interviews (see below for possible outcomes) at most one week after the final candidate is interviewed, and then we will inform you of the final decision by April 14.
...
* prior contributions to `sktime`, `skpro`, `pytorch-forecasting`, and adjacent packages, if applicable
...
## Projects
For potential projects, see our [list of suggested projects](https://github.com/sktime/mentoring/blob/main/internships/projects_2026.md) and [good first issues](https://github.com/alan-turing-institute/sktime/labels/good%20first%20issue).
