# Welcome to sktime's Google Summer of Code program 2026! 
...
The 2026 sktime GSoC program is subject to the [sktime Code of Conduct](https://www.sktime.net/en/stable/get_involved/code_of_conduct.html).

In the remainder of this page:
- [Why sktime](https://github.com/sktime/mentoring/blob/main/internships/gsoc2026.md#why-sktime)
- [The application process](https://github.com/sktime/mentoring/blob/main/internships/gsoc2026.md#the-application-process)
  - [Entrace task, sktime application and GSoC proposal](https://github.com/sktime/mentoring/blob/main/internships/gsoc2026.md#entrace-task-sktime-application-and-gsoc-proposal)
  - [Getting feedback on proposal](https://github.com/sktime/mentoring/blob/main/internships/gsoc2026.md#getting-feedback-on-your-proposal)
  - [Interview](https://github.com/sktime/mentoring/blob/main/internships/gsoc2026.md#interview)
  - [Selection criteria](https://github.com/sktime/mentoring/blob/main/internships/gsoc2026.md#selection-criteria-for-initial-application-phase)
- [What we expect from you](https://github.com/sktime/mentoring/blob/main/internships/gsoc2026.md#what-we-expect-from-you)
- [What you can expect from us](https://github.com/sktime/mentoring/blob/main/internships/gsoc2026.md#what-you-can-expect-from-us)
- [Projects](https://github.com/sktime/mentoring/blob/main/internships/gsoc2026.md#projects)
...
- February 18, 18:00 (UTC). Applications via the sktime application form opens.
- March 16, 18:00 (UTC). Applications via the GSoC proposal form opens.
- March 31, 18:00 (UTC). First stage. You must complete an entrance task, the sktime application form and GSoC proposal by this deadline.
  ...
  - If you are also applying for ESoC, it is sufficient to submit a single sktime application form for both ESoC and GSoC.
- April 4. We inform you of the first stage outcome (proceed to interview) *latest* by April 4, but hopefully sooner.
- April 8 to April 17. Second stage. Interviews happen during this time. Preferred dates are April 8 and April 9. Please keep these dates free if possible.
- April 24. We take at most one week to inform you of the interview outcome. We submit our list of ranked candidates to GSoC.
- April 24 to April 29. Third stage. GSoC makes final selection. No further action from applicants is needed in this stage.
- April 29. GSoC will inform you directly of the final outcome of the process.
...
The deadline to complete all of these is March 31, 18:00 (UTC). If you want feedback on a proposal, then you must complete your proposal at least one week earlier and select the option in the sktime application form. See next subsection for details.
...
After the deadline on March 31 has passed, we will process the information provided and tell you the outcome no later than April 4th. There are two possible outcomes:
...
For feedback after March 24, 18:00 UTC, you must have also submitted your proposal through the GSoC system by March 24, 18:00 (UTC) - you can update this later.
...
For review requests before March 24, we will try to provide feedback to you within five working days. After the deadline on March 26th has passed, we will try to provide feedback to you within three working days.
...
* A rejection. This means you are not in our shortlist sent to GSoC for 2026.
...
## Projects
For potential projects, see our [list of suggested projects](https://github.com/sktime/mentoring/blob/main/internships/projects_2026.md) and [good first issues](https://github.com/sktime/sktime/labels/good%20first%20issue).
