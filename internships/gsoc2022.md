...
This means opening a sensible, non-trivial PR, to show you are able to contribute to sktime. Your PR does not need to be merged at your time of application. 
...
2. Fill in and submit the sktime application form at: TBD. You should have completed your entrance task (point 1 above) before submitting the form, since you need to provide a link to it in the form.
